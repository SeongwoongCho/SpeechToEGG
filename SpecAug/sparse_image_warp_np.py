...
import scipy as sp
import skimage
# from scipy.interpolate import interp2d,spline
...
def sparse_image_warp(image,
    ...
    print("dest_control_point_locations shape",dest_control_point_locations.shape)
    print("control point flows shape ",control_point_flows.shape)
    ...
    print("grid locations shape ",grid_locations.shape)
    print("flattened grid locations shape ",flattened_grid_locations.shape)
...
#     flattened_grid_locations = _expand_to_minibatch(flattened_grid_locations, batch_size)
    ...
    spl = BSpline(dest_control_point_locations, control_point_flows,interpolation_order)
    flattened_flows = np.array([spl(location) for location in flattened_grid_locations])
    
#     flattened_flows = spline(
#         dest_control_point_locations, control_point_flows,
#         flattened_grid_locations, interpolation_order, regularization_weight)
